...
> **This repo (cybergym_tasks20260923G).** The prime bundles live under
> `cybergym_tasks20260923G/`, and the conversion toolkit is a self-contained copy under
...
From the `cybergym_tasks20260923G/` directory (where the bundles are):

```bash
cd cybergym_tasks20260923G
# one bundle
